...
for idx = 1:height(T_global)
    ...
    switch element_slk
        ...
        case 'SG'
            ...
            delta_slk   = sg_slack(T_SG(num_slk,:), T_global{idx,"Sb"}, T_global{idx,"Vb"});
        case 'GFOR'
    ...
    element_slk = T_global{:,"ref_element"};
    bus_slk = T_global{:,"ref_bus"};
    num_slk = T_global{:,'num_slk'};
    delta_slk = T_global{:,'delta_slk'};
end    
